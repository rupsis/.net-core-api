...
namespace PersonalLibrary.API.Entities
{
    public class LibraryContextSeedData
    {
        ...
        public LibraryContextSeedData(LibraryContext libraryContext)
        {
        ...
        public void EnsureSeedDataForContext()
        {
            ...
            // clear db
            _libraryContext.Authors.RemoveRange(_libraryContext.Authors);
            ...
            _libraryContext.Authors.AddRange(authors);
            _libraryContext.SaveChanges();
        }
    }
}
